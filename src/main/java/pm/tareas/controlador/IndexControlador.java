...
import pm.tareas.servicio.TareaServicio;
import java.net.URL;
...
public class IndexControlador implements  Initializable{
    ...
    public void agregarTarea(){
        if(nombreTareaTexto.getText().isEmpty()){
            ...
            var tarea = new Tarea();
            recolectarDtosFormulario(tarea);
    ...
    private  void recolectarDtosFormulario(Tarea tarea){
    ...
    public void eliminarTarea(){
        var tarea = tareaTabla.getSelectionModel().getSelectedItem();
        if (tarea != null){
            logger.info("Regsitro a eliminar: " + tarea.toString());
            tareaServicio.eliminarTare(tarea);
            mostrarMensaje("Informacion", "Tarea eliminada: " + tarea.getIdTarea());
            limpiarFormulario();
            listarTareas();
        }else {
            mostrarMensaje("Error ", "No ha seleccionado ninguna Tarea ");
        }
    }
